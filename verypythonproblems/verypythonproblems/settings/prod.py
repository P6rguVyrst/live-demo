...
ALLOWED_HOSTS = ['demo.verypythonproblems.com']
...
DEFAULT_FROM_EMAIL = 'Very Python Problems <info@demo.verypythonproblems.com>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@demo.verypythonproblems.com'),
]
...
#        'HOST': 'localhost',
#        'NAME': 'verypythonproblems',
#        'USER': 'verypythonproblems',
#        'PASSWORD': '',
