"""
Django settings for verypythonproblems project.
...
WSGI_APPLICATION = 'verypythonproblems.wsgi.application'
...
WAGTAIL_SITE_NAME = "Very Python Problems"

WAGTAIL_ENABLE_UPDATE_CHECK = False

# Base URL to use when referring to full URLs within the Wagtail admin backend -
# e.g. in notification emails. Don't include '/admin' or a trailing slash
BASE_URL = 'http://demo.verypythonproblems.com'
